...
export const RequestLicense = ({ handleClosepopup }) => {
    ...
    function showError(inputId, message) {
        $(inputId).next('.error-message').remove(); // Remove previous error
    ...
    const handleSubmit = async (e) => {
        ...
        if (!isStringValidated(email)) {
            showError("#HR-EnterpriceLicense-email", "Please enter your business email address.");
            errors.push("Please enter your business email address.");
        } else {
            if (!validateEmailidformat(email)) {
                showError("#HR-EnterpriceLicense-email", "Invalid email format. Please enter a valid email address (e.g., user@example.com).");
                ...
                showError("#HR-EnterpriceLicense-email", "Please enter a business email address (e.g., user@company.com). Free email domains are not allowed.");
        ...
        if (!isStringValidated(companyWebsite)) {
            showError("#HR-EnterpriceLicense-CompanyWebsite", "Please enter your company website.");
            errors.push("Please enter your company website.");
        }

        if (!isStringValidated(noOfUsers)) {
            showError("#HR-EnterpriceLicense-NoOfUsers", "Please select the number of users.");
        ...
        try {
            ...
            const data = {
                ...
                EmailBody: emailBody,
                RequestType: "StandardRequestLicense",
            ...
            showMessage('success', `Thank you! We’ve received your request for a free license of ${IAmInterested}.`);
            resetForm();
            setTimeout(() => {
                showMessage();
            }, 3000);
    ...
    return (
        <div className='mainClassforPopup'>
            ...
            {/* <body> */}
                ...
                <div>
                    <h2 className='Request-LicenseHeading'>License Request Form</h2>
                    <form id="bookDemoForm" className="custombookademoform" onSubmit={handleSubmit}>
                        <div>
                            <input
                                className="PhonenumberInput"
                                type="text"
                                id="HR-EnterpriceLicense-Name"
                        ...
                        <div>
                            <input
                                className="PhonenumberInput"
                                type="number"
                                id="HR-EnterpriceLicense-PhoneNumber"
                        ...
                        <div>
                            <input
                                className="PhonenumberInput"
                                type="text"
                                id="HR-EnterpriceLicense-CompanyWebsite"
                        ...
                        <div>
                            <select
                                id="HR-EnterpriceLicense-NoOfUsers"
                                value={noOfUsers}
